...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const isActive = (path: string) => {
    return (
      ...
      (path === "/prompts" && location.pathname === "/response-details")
    );
  };
  ...
  return (
    <>
      <div className={sidebarClasses} onClick={handleSidebarClick}>
        <div
          className={`flex items-center py-2 border-b border-gray-200/50 px-3 min-h-[56px] ${isDesktopCollapsed ? "justify-center" : ""}`}
        >
          {selectedCompany && !isDesktopCollapsed ? (
              ...
              {isCompanyDropdownOpen && (
                <div className="absolute top-full left-0 mt-1 w-full min-w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-50 py-1">
                  ...
                  >
                    <Plus
                      size={14}
                      className={canCreateMore ? "text-black" : "text-gray-400"}
                    />
                    <div className="flex flex-col min-w-0">
                      <span
            ...
            <Link
              ...
              onClick={(e) => isDesktopCollapsed && e.stopPropagation()}
            >
              <img
                src="/Serplexity.svg"
                alt="Serplexity Logo"
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
          <div
            className={`flex flex-col px-4 pt-3 flex-1 overflow-y-auto ${isDesktopCollapsed ? "space-y-1" : "space-y-4"}`}
          >
            <div>
              {!isDesktopCollapsed && (
                <div
              ...
              {(isDesktopCollapsed || openSections.aiPerformance) && (
                ...
                >
                  ...
                  <Link
                    to="/prompts"
                    className={getLinkClass("/prompts")}
                    onClick={(e) => {
                      if (isDesktopCollapsed) e.stopPropagation();
                  ...
                  <Link
                    to="/competitors"
                    className={getLinkClass("/competitors")}
                    onClick={(e) => {
                      if (isDesktopCollapsed) e.stopPropagation();
              ...
              {(isDesktopCollapsed || openSections.aiContentTools) && (
                ...
                >
                  <Link
                    ...
                    className={getLinkClass("/experimental-search")}
                    onClick={(e) => isDesktopCollapsed && e.stopPropagation()}
                  >
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl max-w-2xl w-full mx-4 shadow-2xl max-h-[90vh] overflow-hidden relative">
            <CompanyProfileForm
              isModal={true}
