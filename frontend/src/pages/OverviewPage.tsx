...
const OverviewPage = () => {
  ...
  useEffect(() => {
    if (!isEmbedded) {
      setBreadcrumbs([{ label: "AI Performance" }, { label: "Dashboard" }]);
    }
  ...
  return (
    <div className="h-full flex flex-col relative">
      ...
      {loading ||
      hasReport === null ||
      (hasReport === true && !isDashboardFullyLoaded) ? (
          ...
          <div className="flex-shrink-0 flex flex-col lg:flex-row lg:justify-between lg:items-center gap-3 mb-2">
            <div className="grid grid-cols-2 lg:flex items-center gap-2 w-full lg:w-auto">
              ...
              <FilterDropdown
                ...
                onChange={(value) =>
                  handleFilterChange({ aiModel: value as string })
                }
