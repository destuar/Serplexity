...
const WebAnalyticsPage: React.FC = () => {
  ...
  // Generate stable filters object for cache key; avoid stringifying in hook deps
  ...
  // Check if error is due to missing GA4 integration
  const isGa4MissingError =
    error && error.includes("GA4 integration not active");
            ...
            >
              {selectedMetrics.length === 0 ? (
                ...
                <div className="h-full flex items-center justify-center text-gray-500 text-sm">
                  No time series data available - check browser console for
                  debugging info
                </div>
              ) : (
                <ResponsiveContainer
                    ...
                    {metrics.topReferrers.slice(0, 10).map((referrer, i) => (
                      ...
                      >
                        <div
                          ...
                          title={`${referrer.source} / ${referrer.medium}`}
                        >
