...
describe('User Controller', () => {
  ...
  describe('DELETE /api/users/me/delete', () => {
    ...
    it('should delete user and all related data successfully', async () => {
      ...
      const companiesBefore = await prisma.company.findMany({ where: { userId: userId } });
    ...
    it('should not affect other users data', async () => {
      ...
      const secondUserCompanies = await prisma.company.findMany({ where: { userId: secondUserId } });
