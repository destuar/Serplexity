...
describe('Payment Controller', () => {
  ...
  describe('POST /api/payments/create-checkout-session', () => {
    it('should create a checkout session for authenticated user', async () => {
      ...
      getStripeMock().checkout.sessions.create.mockResolvedValue(mockSession as any);
    ...
    it('should reject unauthenticated requests', async () => {
      ...
      expect(response.body.error).toBe('Authorization header missing or incorrect format');
    });
    ...
    it('should handle Stripe customer creation error', async () => {
      getStripeMock().customers.create.mockRejectedValue(new Error('Stripe error'));
    ...
    it('should handle Stripe session creation error', async () => {
      const mockCustomer = { id: 'cus_test123' };
      getStripeMock().customers.create.mockResolvedValue(mockCustomer as any);
      getStripeMock().checkout.sessions.create.mockRejectedValue(new Error('Session error'));
