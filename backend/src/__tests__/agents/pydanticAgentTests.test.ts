      ...
      const mockExecuteAgent = jest.spyOn(pydanticLlmService, 'executeAgent')
        .mockResolvedValueOnce({
          data: {
            ...
            answer: "TestCorp offers several key advantages including superior performance, better pricing, and excellent customer support.",
            confidence: 0.85,
            sources: [
              {
            ...
            reasoning: "Based on analysis of multiple sources and market comparisons",
            generationTimestamp: new Date().toISOString()
          },
          metadata: {
            modelUsed: "gpt-4.1-mini",
